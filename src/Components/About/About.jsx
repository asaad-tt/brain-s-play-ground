      ...
      <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
        <div className="lg:w-1/2">
          <h2 className="max-w-md mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none xl:max-w-lg">
            To conquer the quiz game you must trust.
          </h2>
        </div>
        <div className="lg:w-1/2">
      ...
      <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mb-3 text-sm text-gray-900">
            We choose to go to html, not because it's easy, but because it's
            Interesting.
          </p>
        ...
        <div>
          ...
          <p className="mb-3 text-sm text-gray-900">
            There can be no thought of finishing for "aiming for the style".
          </p>
          <ul className="mb-4 -ml-1 space-y-2">
            <li className="flex items-start">
              <span className="mr-1">
        ...
        <div>
          ...
          <h6 className="mb-2 font-semibold leading-5">Java script</h6>
          <p className="mb-3 text-sm text-gray-900">
            We are all connected to the coding universe atomically, strong
            bonds.
          </p>
          <ul className="mb-4 -ml-1 space-y-2">
            <li className="flex items-start">
        ...
        <div>
          ...
          <p className="mb-3 text-sm text-gray-900">
            For those who have seen react from heart .
          </p>
          <ul className="mb-4 -ml-1 space-y-2">
            <li className="flex items-start">
              <span className="mr-1">
